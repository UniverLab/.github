...
1. Open an issue or discussion with problem context.
2. Use conventional commits and focused pull requests.
3. Run tests/lint locally before opening a PR.
4. Keep docs/specs updated when behavior changes.
...
We treat software as a moral practice, not only a technical one.
